...
export class InventoryComponent implements OnInit {
  ...
  selectItem(item: string) {
    ...
    const itemCtrl = this.form.get('name') as FormControl
  ...
  addToCart() {
    ...
    console.info('item added >>> ', selection)
  ...
  private createForm(): FormGroup {
    return this.fb.group({
      ...
      unitPrice: this.fb.control<number>(0, [Validators.required, Validators.min(0.05)]),
